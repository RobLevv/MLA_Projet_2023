...
if __name__ == "__main__":
    ...
    print( "Total number of parameters:", sum(p.numel() for p in encoder_layers.parameters() if p.requires_grad) )
    print( "Total number of trainable parameters:", sum(p.numel() for p in encoder_layers.parameters() if p.requires_grad and p.is_leaf) )
    print( "Total number of non-trainable parameters:", sum(p.numel() for p in encoder_layers.parameters() if not p.requires_grad) )
...
if __name__ == "__main__":
    ...
    print( "Total number of parameters:", sum(p.numel() for p in discriminator_layers.parameters() if p.requires_grad) )
    print( "Total number of trainable parameters:", sum(p.numel() for p in discriminator_layers.parameters() if p.requires_grad and p.is_leaf) )
    print( "Total number of non-trainable parameters:", sum(p.numel() for p in discriminator_layers.parameters() if not p.requires_grad) )
# %%
